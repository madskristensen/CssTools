    ...
    internal class FontDropHandler : IDropHandler
    {
        ...
        public string GetCodeFromFile(string fileName, out string fontFamily)
        {
            ...
            for (int i = 0; i < files.Count(); i++)
            {
                ...
                string reference = FileHelpers.RelativePath(ProjectHelpers.DTE.ActiveDocument.FullName, file);
            ...
            fontFamily = fontName;
            fontFamily = Uri.EscapeDataString(fontFamily);
        ...
        private string GetCodeFromLocalhost()
        {
            ...
            draggedFilename = Uri.EscapeDataString(draggedFilename);
